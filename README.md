...
**Watch the full demo:** [View Demo on Google Drive](https://drive.google.com/file/d/1Rn-uf6g_wKS6_DzTShbtXPWxeV2dWQ0z/view?usp=drive_link)
...
```bash
git clone https://github.com/TheRoadSurgeon/CS351-GroupProject.git
cd CS351-GroupProject
```
